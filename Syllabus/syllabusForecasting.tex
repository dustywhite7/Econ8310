...
\vspace*{-6em}
\begin{center}
{\Large ECON 8310 (BSAD 8080)\   \ -- \ Business Forecasting \\[.5em] Date \& Time \ -- \   Room: Thursdays, 6-8:40 PM, MH 115   
}
\end{center}
...
\vskip.25in
\item[\textbf{Office Hours:}] Monday, Thursday from 5-6 PM, and by appointment.

\vskip.25in
\item[\textbf{Materials:}] Course Slides (hosted on Github)\\ Python (I recommend Anaconda, since it comes prepackaged with most of the numeric and analytic libraries we will use)
...
Classification and  Decision Trees \dotfill 2 days\\
...
Daily Lab Completion \dotfill 500 points\\
Midterm Exam \dotfill 250 points \\
Final Exam \dotfill 250 points \\
